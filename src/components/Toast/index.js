  ...
  return (
    <div
      className={classNames(
        'h-28 px-5 w-full max-w-sm fixed bottom-0 -left-full m-4 bg-white rounded-xl flex flex-row gap-x-5 bg-gray-100 items-center justify-between shadow-xl transition-all duration-500'
      )}
      style={{
        left: visible && '0',
      }}
